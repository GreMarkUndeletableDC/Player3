...
void CVeDesktopLyric::TlTick(int iMs) noexcept
{

}

HRESULT CVeDesktopLyric::LrcSetCurrentLine(int idx) noexcept
{
    if (m_idxCurr == idx)
        return S_FALSE;
    m_idxCurr = idx;
...
void CVeDesktopLyric::LrcSetEmptyText(std::wstring_view svEmptyText) noexcept
{

}

void CVeDesktopLyric::SetTextFormatTranslation(IDWriteTextFormat* pTf) noexcept
{
