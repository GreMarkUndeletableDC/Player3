...
public:
    ...
    constexpr static double ProgressTrackBarScale = 100.;

    constexpr static float
        TabPanelWidth = 48.f,
        TitleBarElementHeight = 40.f,
        PageTitleTopPosition = 12.f,
        PageTitleWidth = 120.f,
        ...
        CircleButtonIconSize = 18.f,
        FirstCircleButtonRightPadding = 44.f,
        ControlButtonTopPosition = 18.f,
        PageTitleFontHeight = 20.f,
        VolumeBarWidth = 220.f,
        VolumeBarHeight = 32.f,
        VolumeBarRightPadding = 8.f
        ;
private:
